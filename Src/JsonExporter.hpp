...
public:
  ...
  static bool ExportToFile(const json& exportJson, const std::string& filePath, int width = 2);
  static bool ExportToLink(const json& exportJson, const std::string& linkPath, int width = 2);
